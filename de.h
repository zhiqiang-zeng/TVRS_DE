...
public:
  ...
  void operateCurrentToPBest1BinWithArchive(const vector<Individual>& pop, Individual child, int& target, int t_stop, vector<int>& used_flag, vector<int> &less_index);
  int arc_size;
  int memory_size;
};
